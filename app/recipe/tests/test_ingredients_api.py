...
class PublicIngredientApiTests(TestCase):
    ...
    def test_ingredients_limited_to_user(self):
        ...
        Ingredient.objects.create(user=user2, name='salf')
    ...
    def test_filter_ingredients_assigned_for_recipe(self):
        """Test listing ingredients by those which are assigned to recipe"""
